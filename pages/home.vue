     ...
     <section class="h-auto w-full sm:mb-50 pt-26 lg:pt-38 bg-[url('/images/hero-bg.png')] bg-cover bg-center bg-no-repeat pb-5">
        <div class="container">
            ...
            <div class="flex gap-5 sm:gap-6 items-center justify-center mb-12">
                <button class="cursor-pointer py-3.5 px-8 whitespace-nowrap rounded-full text-white text-base sm:text-lg leading-6 font-bold gradient-button">Buy Now</button>
     ...
     <section class="py-20 sm:py-40">
        <div class="container">
            <div class="max-w-[934px] w-full mx-auto mb-12 sm:mb-16">
                <h1 class="text-3xl lg:text-[42px] font-bold text-center leading-tight mb-6">eBazaar Has<span class="gradient-text"> Everything to Manage </span>Your Retail eCommerce Business with Ease</h1>
     ...
     <section class="container">
        <div class="mb-20 sm:mb-40">
            <div class="max-w-[934px] w-full mx-auto flex flex-col items-center justify-center mb-8 md:mb-16">
                ...
                <h1 class="text-3xl lg:text-[42px] font-bold text-center leading-tight mb-6">Powerful & Effective<span class="gradient-text"> Features to Automate & Optimize </span>Your Business Effortlessly</h1>
        ...
        <div class="pt-20 pb-20 sm:pb-40 md:px-20 bg-[url('/images/bg/six-steps-bg.png')] bg-contain md:bg-cover bg-no-repeat bg-top">
            <div class="container">
                <div class="max-w-[460px] md:max-w-[542px] lg:max-w-[742px] w-full mx-auto flex flex-col items-center justify-center px-6 mb-12 md:mb-16">
                    <h1 class="text-3xl lg:text-[42px] font-bold text-center leading-tight mb-6">Get Started with eBazaar<span class="text-primary"> in Just Six Simple Steps</span></h1>
    ...
    <!--===============================
     ...
     <section class="container">
        <div class="mb-20 sm:mb-40 relative">
            <span class="absolute -z-10 top-32 left-1/2 -translate-x-1/2 w-[580px] h-[75px] rotate-[35deg] blur-[300px] bg-[#95FFD6]"></span>
            <div class="max-w-[934px] w-full mx-auto flex flex-col items-center justify-center mb-8 md:mb-16  relative">
                <h1 class="text-3xl lg:text-[42px] font-bold text-center leading-tight mb-6">Enhance Business Efficiency with Reliable<span class="gradient-text"> Payment </span> &<span class="gradient-text"> SMS Gateways </span></h1>
     ...
     <section class="container">
        <div class="mb-20 sm:mb-40">
            <div class="p-8 md:p-12 md:pb-0 rounded-2xl bg-custom-gradient relative z-0">
                <NuxtImg class="absolute right-0 top-0 -z-1 max-w-[455px] w-full"  src="/images/vector/Union.png"/>
                <div class="grid grid-cols-12 md:gap-14 relative z-10">
                    ...
                    <div class="col-span-12 md:col-span-7">
                        <NuxtImg class="w-full h-full mb-6" src="/images/vector/used_technology.png" alt="technologies"/>
                    </div>
                </div>
            </div>
        </div>    
                ...
                <div class="relative">
                    <div class="flex flex-col justify-center items-center">
                        <h2 class="text-3xl md:text-[42px] leading-tight text-center font-bold mb-6">Start Your Journey with FoodKing & Build a
                            <span class="gradient-text"> Restaurant Business </span>
                            Today!
                            </h2>
                        ...
                        <div class="flex flex-wrap gap-6 items-center justify-center">
                             <button class="gradient-button">Buy Now</button>
