    ...
    <!--===============================
     ...
     <section class="container">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-20 sm:mb-40">
            <div v-for="plan in packages" :class="[plan.popular ? 'active' : '']" class="installation-plan group">
                <div class="flex justify-between mb-4">
                    <div class="w-9 h-9 rounded-full bg-[#D1FFED] flex items-center justify-center"><i :class="plan.icon" class="text-primary"></i></div>
                    <span v-if="plan.popular" class="text-xs font-semibold bg-[#FF4200] h-fit px-2 py-1.5 rounded-full text-white">Most Popular</span>
                </div>
